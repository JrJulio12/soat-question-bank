...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Edit Unit</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Update unit information</p>
        </div>
            ...
            <div class="p-6">
                <form action="{{ route('units.update', $unit) }}" method="POST">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('units.show', $unit) }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
                            Cancel
                        </a>
                    </div>
                </form>
