...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Create Chapter</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Add a new chapter to the system</p>
        </div>
