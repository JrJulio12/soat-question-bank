...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">{{ $serie->name }}</h1>
                ...
                <div class="p-6">
                    ...
                    <dl class="space-y-3">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-[#1b1b18] dark:text-[#EDEDEC]">{{ $serie->name }}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-[#1b1b18] dark:text-[#EDEDEC]">{{ $serie->order ?? '-' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <dl class="space-y-3">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-[#1b1b18] dark:text-[#EDEDEC]">{{ $serie->bnccs->count() }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
